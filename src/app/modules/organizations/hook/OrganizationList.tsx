                ...
                <td>
                    <div className='symbol-group symbol-hover flex-nowrap'>
                        ...
                        <Link to={`/organizations/${item?.organizationId}/contributors`} className="symbol symbol-30px symbol-circle">
                            {contributors?.total_value && <span className="symbol-label fs-8 fw-bold bg-dark text-gray-300">{calculContributors <= 0 ? contributors?.total : `+${calculContributors}`}</span>}
                        </Link>
                    </div>
                </td>
                <td>
